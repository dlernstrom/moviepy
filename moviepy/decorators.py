        ...
        if fps is not None:
            ...
            if hasattr(clip, 'fps') and clip.fps is not None:
                ...
                raise AttributeError(
                    "No 'fps' (frames per second) attribute specified for"
                    " function %s and the clip has no 'fps' attribute. Either"
                    " provide e.g. fps=24 in the arguments of the function, or"
                    " define the clip's fps with `clip.fps=24`" % f.__name__)
